...
===================================
Happy gardening!
===================================</code>`),a(p);var u=t(p,20),v=n(u);s(v,()=>'<code class="language-console">npm run garden</code>'),a(u),y(8),g(i,e)}var I=c('<meta name="description" content="Installation guide. Gardenjs is the fast component UI explorer for JavaScript frameworks like Svelte, Vue and React."/>'),S=c('<div class="md_file"><!></div>');function E(i){var e=S();k("1yyoswb",d=>{var o=I();w(()=>{b.title="Installation guide :: Gardenjs Docs"}),g(d,o)});var r=n(e);G(r),a(e),g(i,e)}export{E as component};
