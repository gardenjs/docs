    ...
    .navbar {
      ...
      .navbar-btns {
        ...
        #toggle-mode {
          ...
          width: 2rem;
          height: 2rem;
          background-image: var(--icon-toggle-mode);
