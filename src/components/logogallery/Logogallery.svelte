	...
	<ul class="logos">
		...
		<li>
			<svg
				...
				/><g transform="matrix(5.5 0 0 5.50477 64 64)" fill="none" stroke="#61dafb"
					><ellipse rx="11" ry="4.2" /><ellipse rx="11" ry="4.2" transform="rotate(60)" /><ellipse
						rx="11"
						ry="4.2"
		...
		<li>
			<svg class="icon" role="img" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"
				><title>HTML</title><path fill="#E34F26" d="M71 460L30 0h451l-41 460-185 52" /><path
					fill="#EF652A"
		...
		<li>
			<svg
				...
				stroke-linejoin="round"
				><title>Write your own Gardenjs renderer plugin to support more JS framework.</title><circle
					cx="12"
					cy="12"
					r="1"
