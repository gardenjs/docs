<script>
  ...
  const accordionItems = [
    ...
    {
      label:
        'Do you have further questions or is there something on your mind?',
...
<svelte:head>
  ...
  <meta
    name="description"
    content="Gardenjs is the fast component UI explorer for JavaScript frameworks like Svelte, Vue and React."
  />
</svelte:head>
