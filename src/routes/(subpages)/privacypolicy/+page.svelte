...
<Main>
  <div>
    ...
    <p>
      ...
      may, for example, be data that you enter in a contact form.
    </p>
    <p>
    ...
    <h2>2. Hosting</h2>
    <p>
      Our host collects the following data that your browser transmits in log
      files:
    </p>
    <p>
      IP address, the address of the previously visited website (referrer
    ...
    <p>
      ...
      of Art. 6 para. 1 sentence 1 lit. f GDPR.
    </p>
    ...
    <p>
      GitHub Inc.<br />88 Colin P Kelly Jr St<br />San Francisco, CA 94107<br
      />United States
    </p>
    <p>
    ...
    <p>
      Further information on objection and removal options vis-à-vis GitHub can
      be found at: <a
    ...
    <p>
      ...
      successful must be determined as part of a balancing of interests.
    </p>
    <p>
      The data will be deleted as soon as the purpose of the processing no
      longer applies.
    </p>
    <p>
      The processing of the data specified in this section is not required by
    ...
    <p>
      In principle, an order processing contract must be concluded with the
      ...
      primarily serves the hoster's security purposes."
    </p>
    <p>
      (<a
    ...
    <p>
      In the event of breaches of the GDPR, data subjects have the right to
    ...
    <ul>
      ...
      <li>
        If the processing of your personal data was/is carried out unlawfully,
        you can request the restriction of data processing instead of erasure.
      </li>
      <li>
    ...
    <p>
      ...
      of important public interest of the European Union or of a Member State.
    </p>
    <h3>Objection to advertising e-mails</h3>
    <p>
      We hereby object to the use of contact data published as part of our
