...
<Main>
  <div>
    ...
    <p>(<a href="https://www.lda.bayern.de/media/veroeffentlichungen/FAQ_Hosting_keine_Auftragsverarbeitung.pdf" target="_blank"> PDF: FAQ Hosting no order processing)</a> We assume that this exception applies to GitHub Pages.</p>
